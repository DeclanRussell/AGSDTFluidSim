...
\begin{DoxyCompactList}\small\item\em This class uses cuda and parralel algorithms to manage particles in a fluid simulation. \end{DoxyCompactList}\end{DoxyCompactItemize}
