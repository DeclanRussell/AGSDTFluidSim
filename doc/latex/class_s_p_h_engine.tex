...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{class_s_p_h_engine_afe2b02e535cf064f91f2de4312c8ae39_icgraph}
\end{center}
\end{figure}
...
\end{DoxyReturn}
\hypertarget{class_s_p_h_engine_ac97832913d04297e83c33ada3ae5ae53}{\index{S\-P\-H\-Engine@{S\-P\-H\-Engine}!next\-Prime\-Num@{next\-Prime\-Num}}
\index{next\-Prime\-Num@{next\-Prime\-Num}!SPHEngine@{S\-P\-H\-Engine}}
\subsubsection[{next\-Prime\-Num}]{\setlength{\rightskip}{0pt plus 5cm}unsigned int S\-P\-H\-Engine\-::next\-Prime\-Num (
\begin{DoxyParamCaption}
\item[{int}]{\-\_\-x}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}}\label{class_s_p_h_engine_ac97832913d04297e83c33ada3ae5ae53}


a simple function to caluclate next prime number of the inpur variable 


\begin{DoxyParams}{Parameters}
{\em \-\_\-x} & -\/ vaule you wish to calculate next prime number for \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
the next lowest prime number higher than our input value \-\_\-\-X 
\end{DoxyReturn}
