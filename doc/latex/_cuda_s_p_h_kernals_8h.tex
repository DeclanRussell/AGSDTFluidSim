...
void \hyperlink{_cuda_s_p_h_kernals_8h_a74b195a988479a037d731bbf2da30a5f}{create\-Hash\-Table} (unsigned int $\ast$d\-\_\-hash\-Array, float3 $\ast$d\-\_\-pos\-Array, unsigned int num\-Particles, float smoothing\-Legnth, unsigned int hash\-Table\-Size, int max\-Num\-Threads)
...
void \hyperlink{_cuda_s_p_h_kernals_8h_ab684f435c5cd455ffa3eb7bed7d9f500}{reset\-Cell\-Idx\-And\-Den} (unsigned int $\ast$\-\_\-cell\-Idx\-Ptr, unsigned int \-\_\-hash\-Table\-Size, float $\ast$\-\_\-den\-Ptr, unsigned int \-\_\-den\-Size, int \-\_\-max\-Num\-Threads, cuda\-Stream\-\_\-t \-\_\-stream1, cuda\-Stream\-\_\-t \-\_\-stream2)
\begin{DoxyCompactList}\small\item\em simple function that resets our cell index buffer and our density buffer to 0 \end{DoxyCompactList}\item 
void \hyperlink{_cuda_s_p_h_kernals_8h_a7f87fc3a29fdd5a734ee8c5c5d2a4b83}{fluid\-Solver} (float3 $\ast$d\-\_\-pos\-Array, float3 $\ast$d\-\_\-vel\-Array, float3 $\ast$d\-\_\-acc\-Array, float $\ast$d\-\_\-den\-Array, unsigned int $\ast$d\-\_\-cell\-Occ\-Array, unsigned int $\ast$d\-\_\-cell\-Indx\-Array, unsigned int \-\_\-hash\-Table\-Size, unsigned int \-\_\-max\-Num\-Threads, float \-\_\-smoothing\-Length, float \-\_\-timestep, float \-\_\-particle\-Mass=1, float \-\_\-rest\-Density=1, float \-\_\-gas\-Constant=1, float \-\_\-vis\-Coef=1, float \-\_\-dens\-Kern\-Const=1, float \-\_\-press\-Kern\-Const=1, float \-\_\-visc\-Kern\-Const=1)
...
\hline
\end{DoxyParams}
\hypertarget{_cuda_s_p_h_kernals_8h_a74b195a988479a037d731bbf2da30a5f}{\index{Cuda\-S\-P\-H\-Kernals.\-h@{Cuda\-S\-P\-H\-Kernals.\-h}!create\-Hash\-Table@{create\-Hash\-Table}}
...
\item[{float}]{smoothing\-Legnth, }
\item[{unsigned int}]{hash\-Table\-Size, }
\item[{int}]{max\-Num\-Threads}
\end{DoxyParamCaption}
)}}\label{_cuda_s_p_h_kernals_8h_a74b195a988479a037d731bbf2da30a5f}
...
\hline
{\em num\-Particles} & -\/ the number of particles. Used to calculate how many kernals to launch \\
\hline
{\em smoothing\-Length} & -\/ smoothing length of our hash. How big each cell of our hash is. \\
\hline
{\em hash\-Table\-Size} & -\/ size of our hash table You can think of this as how many different hash keys availible. \\
\hline
{\em max\-Num\-Threads} & -\/ the maximum number off threads we have in a block on our device. Can be found out with device query \\
\hline
\end{DoxyParams}
\hypertarget{_cuda_s_p_h_kernals_8h_a7f87fc3a29fdd5a734ee8c5c5d2a4b83}{\index{Cuda\-S\-P\-H\-Kernals.\-h@{Cuda\-S\-P\-H\-Kernals.\-h}!fluid\-Solver@{fluid\-Solver}}
...
\end{DoxyParamCaption}
)}}\label{_cuda_s_p_h_kernals_8h_a7f87fc3a29fdd5a734ee8c5c5d2a4b83}
...
\hline
\end{DoxyParams}
\hypertarget{_cuda_s_p_h_kernals_8h_ab684f435c5cd455ffa3eb7bed7d9f500}{\index{Cuda\-S\-P\-H\-Kernals.\-h@{Cuda\-S\-P\-H\-Kernals.\-h}!reset\-Cell\-Idx\-And\-Den@{reset\-Cell\-Idx\-And\-Den}}
\index{reset\-Cell\-Idx\-And\-Den@{reset\-Cell\-Idx\-And\-Den}!CudaSPHKernals.h@{Cuda\-S\-P\-H\-Kernals.\-h}}
\subsubsection[{reset\-Cell\-Idx\-And\-Den}]{\setlength{\rightskip}{0pt plus 5cm}void reset\-Cell\-Idx\-And\-Den (
\begin{DoxyParamCaption}
\item[{unsigned int $\ast$}]{\-\_\-cell\-Idx\-Ptr, }
\item[{unsigned int}]{\-\_\-hash\-Table\-Size, }
\item[{float $\ast$}]{\-\_\-den\-Ptr, }
\item[{unsigned int}]{\-\_\-den\-Size, }
\item[{int}]{\-\_\-max\-Num\-Threads, }
\item[{cuda\-Stream\-\_\-t}]{\-\_\-stream1, }
\item[{cuda\-Stream\-\_\-t}]{\-\_\-stream2}
\end{DoxyParamCaption}
)}}\label{_cuda_s_p_h_kernals_8h_ab684f435c5cd455ffa3eb7bed7d9f500}


simple function that resets our cell index buffer and our density buffer to 0 


\begin{DoxyParams}{Parameters}
{\em \-\_\-cell\-Idx\-Ptr} & -\/ pointer to the cell index buffer to reset \\
\hline
{\em \-\_\-hash\-Table\-Size} & -\/ size of the cell idx buffer \\
\hline
{\em \-\_\-den\-Ptr} & -\/ pointer to our density buffer \\
\hline
{\em \-\_\-den\-Size} & -\/ size of our density buffer \\
\hline
{\em \-\_\-max\-Num\-Threads} & -\/ maxium number of threads we have per block \\
\hline
{\em \-\_\-stream1} & -\/ optional stream can be set to improove concurrency having both kernals run at the same time \\
\hline
{\em \-\_\-stream2} & -\/ optional stream can be set to improove concurrency having both kernals run at the same time \\
\hline
\end{DoxyParams}
